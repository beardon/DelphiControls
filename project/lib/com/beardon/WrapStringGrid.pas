...
type
  TWrapStringGrid = class(TStringGrid)
  private
...
constructor TWrapStringGrid.Create(AOwner : TComponent);
begin
...
{ This DrawCell procedure wraps text in the grid cell }
procedure TWrapStringGrid.DrawCell(ACol, ARow : Longint; ARect : TRect;
...
procedure Register;
begin
  RegisterComponents('Beardon', [TWrapStringGrid]);
end;
